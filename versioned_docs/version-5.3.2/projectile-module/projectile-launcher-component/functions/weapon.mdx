...
* `Reset Ammo Sequence Index` : If true, `AmmoSequenceIndex`
will be reset.
...
* `Enabled`  : If true, the projectile launcher can fire.
...
* `Fire Mode`  : The new [fire mode](/docs/projectile-module/types#fire-mode).
