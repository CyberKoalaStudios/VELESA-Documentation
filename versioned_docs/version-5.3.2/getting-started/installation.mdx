...
Open the Epic Games Launcher and select Unreal Engine   on the left side.

Next, select the Library   tab at the top and search for `VELESA` in the VAULT section to quickly find our plugins.
Finally, click on the *Install to Engine*  button of the plugin you want to install to a specific Unreal Engine on your computer.
